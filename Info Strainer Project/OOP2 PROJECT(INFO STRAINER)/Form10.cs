...
namespace OOP2_PROJECT_INFO_STRAINER_
{
    public partial class Form10 : Form
    {
        ...
        int[] rainSpeeds = { 2, 4, 2, 5, 1, 2, 3, 4, 3, 5, 4 };
        int loadingSpeed = 1;
            ...
            for (int i = 0; i < 11; i++)
            {
                switch (i)
                {
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        // animation for rain 11
                        pictureBox14.Location = new Point(pictureBox14.Location.X, pictureBox14.Location.Y + rainSpeeds[i]);
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            if (initialPercentage >= 100)
            {
                this.timer2.Stop();
                Form8 f = new Form8();
                f.PrimaryKey = this.PrimaryKey;
                f.comingFromExpert = this.comingFromExpert;
                this.Hide();
                f.Show();
